...
export class MemoryManager {
  constructor(runsDir, { thresholds = {}, maxBaselineAgeMs = Number.POSITIVE_INFINITY } = {}) {
  ...
  addRun(synthesizedData) {
    ...
    const baselineIsStale = baselineAgeMs > this.maxBaselineAgeMs;
    const delta = baselineIsStale
      ? this._baselineResetDelta(synthesizedData, previous, baselineAgeMs)
      : computeDelta(synthesizedData, previous, this.thresholds, priorRuns);
